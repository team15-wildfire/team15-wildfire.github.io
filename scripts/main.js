...
if(temp_val_check>120 && co_val_check>1500){
  Body="There is an alarm going off at node "+node_pos_val_check+" at time "+time_val_check+" with temperature "+temp_val_check+" (degrees farenheight) and gas a concentration of "+co_val_check+" parts per million"
 sendEmail(Body);
